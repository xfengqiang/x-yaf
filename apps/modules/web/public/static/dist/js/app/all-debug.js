 ...
 */
define("app/account/login-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug" ], function(require, exports) {
    var $ = require("lib/jquery/jquery/1.8.2/jquery-debug");
 ...
 * Created by Administrator on 15-9-2.
 */
define("app/account/register-debug", [ "lib/jquery/validate/jquery.validate-debug" ], function(require, exports, module) {
    //   var $ = require("jquery");
    var $ = require("lib/jquery/validate/jquery.validate-debug");
    console.log($);
...
define("app/index/index-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug", "dialog-debug" ], function(require, exports) {
    var $ = require("lib/jquery/jquery/1.8.2/jquery-debug"), Dialog = require("dialog-debug");
 ...
 * Created by Administrator on 15-9-2.
 */
define("app/tpl/index-debug", [ "tpl/index/index-debug", "tpl/common/header-debug", "tpl/common/footer-debug", "tpl/template-debug", "lib/jquery/jquery/1.8.2/jquery-debug" ], function(require, exports) {
    // 演示JSON数据
    var data = {
        title: "国内要闻",
    ...
    var render = require("tpl/index/index-debug");
    var content = render(data);
    var $ = require("lib/jquery/jquery/1.8.2/jquery-debug");
    $("#content").html(content);
});
define("common/dialog/dialog-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug", "./dialog_css-debug.css" ], function(require, exports, module) {
    var $ = require("lib/jquery/jquery/1.8.2/jquery-debug");
 ...
 * Created by Administrator on 15-9-2.
 */
define("common/util/util-debug", [], function(require, exports, module) {
 ...
 */
    ...
    if (typeof define === "function") {
        define("lib/artTemplate/template-debug-debug", [], function() {
            return template;
        });
...
!function() {
    ...
    e.parser = function(a) {
        ...
        return a;
    }, "function" == typeof define ? define("lib/artTemplate/template-debug", [], function() {
        return d;
...
(function(factory) {
    if (typeof define === "function" && define.amd) {
        define("lib/jquery/validate/additional-methods-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug", "./jquery.validate-debug" ], factory);
    } else if (typeof define === "function" && define.cmd) {
        define("lib/jquery/validate/additional-methods-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug", "./jquery.validate-debug" ], function(require) {
            var $ = require("lib/jquery/jquery/1.8.2/jquery-debug");
            factory($);
            return $;
        });
...
(function(factory) {
    if (typeof define === "function" && define.amd) {
        define("lib/jquery/validate/jquery.validate-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug" ], factory);
    } else if (typeof define === "function" && define.cmd) {
        define("lib/jquery/validate/jquery.validate-debug", [ "lib/jquery/jquery/1.8.2/jquery-debug" ], function(require) {
            var $ = require("lib/jquery/jquery/1.8.2/jquery-debug");
            factory($);
            return $;
        });
...
define("tpl/common/footer-debug", [ "../copyright-debug", "../template-debug" ], function(require) {
    return require("../copyright-debug"), require("../template-debug")("common/footer", function($data, $filename) {
        "use strict";
...
/*TMODJS:{"version":1,"md5":"f547a08d08f184fd6f93c4a2409c3db6"}*/
define("tpl/common/header-debug", [ "./logo-debug", "../template-debug" ], function(require) {
    return require("./logo-debug"), require("../template-debug")("common/header", function($data, $filename) {
        "use strict";
...
/*TMODJS:{"version":1,"md5":"5d4c9b87a3362119792249222cacd754"}*/
define("tpl/common/logo-debug", [ "../template-debug" ], function(require) {
    return require("../template-debug")("common/logo", ' <h1 id="logo"> <a href="http://www.qq.com"> <img width=\'134\' height=\'44\' src="http://mat1.gtimg.com/www/images/qq2012/qqlogo_1x.png" alt="腾讯网" /> </a> </h1> ');
});
/*TMODJS:{"version":1,"md5":"1aa8467a8b0c86d21fde333b1ee7696d"}*/
define("tpl/copyright-debug", [ "./template-debug" ], function(require) {
    return require("./template-debug")("copyright", "(c) 2013");
});
/*TMODJS:{"version":1,"md5":"b7b2e5053b8f65a9a004e1e61d59d9c1"}*/
define("tpl/index/index-debug", [ "../common/header-debug", "../common/logo-debug", "../template-debug", "../common/footer-debug", "../copyright-debug" ], function(require) {
    return require("../common/header-debug"), require("../common/footer-debug"), require("../template-debug")("index/index", function($data, $filename) {
        "use strict";
        var $utils = this, include = ($utils.$helpers, function(filename, data) {
            data = data || $data;
            var text = $utils.$include(filename, data, $filename);
...
!function() {
    ...
    template.get = function(filename) {
        ...
        helpers[name] = helper;
    }, define("tpl/template-debug", [], function() {
        return template;
    });
}();